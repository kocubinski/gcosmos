...
const (
	...
	GordianGRPC_QueryTx_FullMethodName             = "/gordian.server.v1.GordianGRPC/QueryTx"
)
...
type GordianGRPCClient interface {
	...
	// Emulate the SDK's built-in comet querying.
	QueryTx(ctx context.Context, in *SDKQueryTxRequest, opts ...grpc.CallOption) (*SDKQueryTxResponse, error)
}
...
func (c *gordianGRPCClient) GetBlocksWatermark(ctx context.Context, in *CurrentBlockRequest, opts ...grpc.CallOption) (*CurrentBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, GordianGRPC_GetBlocksWatermark_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gordianGRPCClient) GetValidators(ctx context.Context, in *GetValidatorsRequest, opts ...grpc.CallOption) (*GetValidatorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, GordianGRPC_GetValidators_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gordianGRPCClient) SubmitTransaction(ctx context.Context, in *SubmitTransactionRequest, opts ...grpc.CallOption) (*TxResultResponse, error) {
	...
	err := c.cc.Invoke(ctx, GordianGRPC_SubmitTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gordianGRPCClient) SimulateTransaction(ctx context.Context, in *SubmitSimulationTransactionRequest, opts ...grpc.CallOption) (*TxResultResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TxResultResponse)
	err := c.cc.Invoke(ctx, GordianGRPC_SimulateTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gordianGRPCClient) PendingTransactions(ctx context.Context, in *PendingTransactionsRequest, opts ...grpc.CallOption) (*PendingTransactionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, GordianGRPC_PendingTransactions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gordianGRPCClient) QueryAccountBalance(ctx context.Context, in *QueryAccountBalanceRequest, opts ...grpc.CallOption) (*QueryAccountBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, GordianGRPC_QueryAccountBalance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gordianGRPCClient) QueryTx(ctx context.Context, in *SDKQueryTxRequest, opts ...grpc.CallOption) (*SDKQueryTxResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SDKQueryTxResponse)
	err := c.cc.Invoke(ctx, GordianGRPC_QueryTx_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GordianGRPCServer interface {
	...
	// Emulate the SDK's built-in comet querying.
	QueryTx(context.Context, *SDKQueryTxRequest) (*SDKQueryTxResponse, error)
	mustEmbedUnimplementedGordianGRPCServer()
}

// UnimplementedGordianGRPCServer must be embedded to have
...
func (UnimplementedGordianGRPCServer) QueryTx(context.Context, *SDKQueryTxRequest) (*SDKQueryTxResponse, error) {
...
func (UnimplementedGordianGRPCServer) testEmbeddedByValue()                     {}
...
func RegisterGordianGRPCServer(s grpc.ServiceRegistrar, srv GordianGRPCServer) {
	// If the following call pancis, it indicates UnimplementedGordianGRPCServer was
...
func _GordianGRPC_QueryTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SDKQueryTxRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GordianGRPCServer).QueryTx(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GordianGRPC_QueryTx_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GordianGRPCServer).QueryTx(ctx, req.(*SDKQueryTxRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GordianGRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueryTx",
			Handler:    _GordianGRPC_QueryTx_Handler,
		},
	},
